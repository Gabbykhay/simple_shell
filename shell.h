...
/*struct passinfo - contain pseudo-arguements to pass into a function,this
  ...
  @linecount_flag: if this is on count this line of input_
   @cmd_buf_type: this isCMD_type ||, &&, ;
  @readfd: this isthe fd from which to read line input
...
typedef struct passinfo
{
	...
	char **cmd_buf; // this ispointer to cmd ; chain buffer, for memory mangement
//int cmd_buf_type; /*this is CMD_type ||, &&, ;
	int readfd;
	int histcount;
} info_t;
...
/*
  ...
  @type: this isthe builtin command flag
