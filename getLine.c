...
/*_getline this gets the next line of input from STDIN
  ...
  @length: the size of preallocate111111111111111111111111111111 ptr buffer if not NULL
...
/*sigintHandler this blocks ctrl-C
  @sig_num: the signal nums or num
  Return: void
 */
