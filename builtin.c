...
/*
  _myexit this exits the shell or ssh
  @info: this the tructure containing potential arguments. Used to maintain
...
//@info:  thr Structure containing potential arguments. Used to maintain
//constant function prototype.
//Return: Always 0  */
